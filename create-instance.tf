resource "google_compute_instance" "default" {
  ...
  network_interface {
    ...
    metadata_startup_script =  "${file("/Users/frankwu/MyDir/git/code_example/config_file/os_init_install_prerequisite.sh")}"
    metadata = {
    sshKeys = "frankwu:${file("~/.ssh/id_rsa.pub")}"
    }
